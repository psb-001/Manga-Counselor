  ...
  <section className="mb-16">
    ...
    <div className="prose prose-invert max-w-none">
      <p className="text-lg text-zinc-300 leading-relaxed">
        Founded in 2025, MangaCounselor was born from a passion for connecting readers with stories that resonate with them. We believe that the right manga can inspire, comfort, and transform lives.
      </p>
